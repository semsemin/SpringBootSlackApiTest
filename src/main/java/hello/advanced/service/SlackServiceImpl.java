package hello.advanced.service;
...
@Service
public class SlackServiceImpl implements SlackApiService{
    ...
    public void sendMessageToChannel(String channel, String message){
        ...
        this.webClient.post()
                ...
                .doOnError(error -> System.out.println("Slack Error : " + error.getMessage())) // 실패
                .subscribe();
    }
